...
INSERT INTO CUSTOMERS (CUSTOMER_ID, CUSTOMER_NAME, AGE, BALANCE, IS_VIP) VALUES (1, 'Alice Smith', 65, 8000, 'FALSE');
INSERT INTO CUSTOMERS (CUSTOMER_ID, CUSTOMER_NAME, AGE, BALANCE, IS_VIP) VALUES (2, 'Bob Johnson', 55, 12000, 'FALSE');
INSERT INTO CUSTOMERS (CUSTOMER_ID, CUSTOMER_NAME, AGE, BALANCE, IS_VIP) VALUES (3, 'Charlie Brown', 70, 5000, 'FALSE');
INSERT INTO CUSTOMERS (CUSTOMER_ID, CUSTOMER_NAME, AGE, BALANCE, IS_VIP) VALUES (4, 'Diana Prince', 40, 15000, 'FALSE');
INSERT INTO CUSTOMERS (CUSTOMER_ID, CUSTOMER_NAME, AGE, BALANCE, IS_VIP) VALUES (5, 'Eve Adams', 62, 9000, 'FALSE');
INSERT INTO CUSTOMERS (CUSTOMER_ID, CUSTOMER_NAME, AGE, BALANCE, IS_VIP) VALUES (6, 'Frank Green', 30, 7000, 'FALSE');

INSERT INTO LOANS (LOAN_ID, CUSTOMER_ID, INTEREST_RATE, DUE_DATE, AMOUNT) VALUES (101, 1, 6.50, TO_DATE('2025-07-15', 'YYYY-MM-DD'), 25000);
INSERT INTO LOANS (LOAN_ID, CUSTOMER_ID, INTEREST_RATE, DUE_DATE, AMOUNT) VALUES (102, 2, 7.00, TO_DATE('2025-08-01', 'YYYY-MM-DD'), 50000);
INSERT INTO LOANS (LOAN_ID, CUSTOMER_ID, INTEREST_RATE, DUE_DATE, AMOUNT) VALUES (103, 3, 6.80, TO_DATE('2025-07-05', 'YYYY-MM-DD'), 10000);
